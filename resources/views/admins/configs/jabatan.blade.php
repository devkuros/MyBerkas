...
@section('admin-tittle')Jabatan @endsection
...
<div class="page-header">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
         <a class="btn btn-primary float-right my-3" href="javascript:void(0)" id="createNew"> Tambah Jabatan</a>
        </div>
     </div>
</div>
...
$(function () {
    ...
    $('#createNew').click(function () {
            ...
            $('#titleModal').html("Tambah Jabatan");
    ...
    $('body').on('click', '.editData', function () {
            ...
            $.get('jabatan/' + id + '/edit', function (data) {
                $('#titleModal').html("Edit " + data.nama_jabatan);
    ...
    $('#ajaxForm').submit(function (e) {
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                toast({
                    type: 'success',
                    title: data.nama_jabatan + ' data is successfully saved',
                    padding: '2em',
                })
            },
            error: function (data) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    setTimeout(function () {
                        ...
                        toast({
                            type: 'success',
                            title: ' Jabatan is successfully delete',
                            padding: '2em',
                        })
                    });
