...
@section('admin-tittle')Permission @endsection
...
<div class="page-header">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
         <a class="btn btn-primary float-right my-3" href="javascript:void(0)" id="createNew"> Create Permission</a>
        </div>
     </div>
</div>
...
$(function () {
    ...
    $('#createNew').click(function () {
            ...
            $('#titleModal').html("Create Permission");
    ...
    $('body').on('click', '.editData', function () {
            ...
            $.get('permission/' + id + '/edit', function (data) {
                $('#titleModal').html("Edit " + data.name);
    ...
    $('#ajaxForm').submit(function (e) {
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                toast({
                    type: 'success',
                    title: data.name + ' data is successfully saved',
                    padding: '2em',
                })
            },
            error: function (data) {
                ...
                toast({
                    type: 'error',
                    title: ' Permission must be filled',
                    padding: '2em',
                })
                $('#saveBtn').html('Save');
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    setTimeout(function () {
                        ...
                        toast({
                            type: 'success',
                            title: ' Permission is successfully delete',
                            padding: '2em',
                        })
                    });
