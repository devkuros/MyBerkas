...
@section('admin-tittle')Role @endsection
...
<div class="page-header">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
         <a class="btn btn-primary float-right my-3" href="javascript:void(0)" id="createNew"> Create Role</a>
        </div>
     </div>
</div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    setTimeout(function () {
                        ...
                        toast({
                            type: 'success',
                            title: ' Role is successfully delete',
                            padding: '2em',
                        })
                    });
