    ...
    <div class="widget-content widget-content-area br-6">
        <div class="row">
            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                <h4>Arsip Surat Keluar Fakultas Teknologi Industri</h4>
            </div>
        </div>
        <hr>
    ...
    $(function () {
        ...
        var datatable = $('#dtable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'tgl_surat_keluar',
                        name: 'tgl_surat_keluar',
                    },
                    {
                        data: 'action',
                        name: 'action',
        ...
        $('body').on('click', '.editData', function () {
                ...
                $.get(' fakultas/' + id + '/edit', function (data) {
                    ...
                    $('#tgl_surat_keluar').val(data.tgl_surat_keluar);
                })
        });
        ...
        $('#btnDelete').click(function () {
                $.ajax({
                    url: "fakultas/surat-keluar/delete/" + data,
                    type: 'delete',
                    beforeSend: function () {
