...
@section('admin-tittle')Input Surat Keluar @endsection
            ...
            <div class="col-lg-12 col-12  layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <form enctype="multipart/form-data" method="POST" action="{{ route('keluars.store') }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input id="when" class="form-control flatpickr flatpickr-input active @error('tgl_surat_keluar') is-invalid @enderror" type="text" name="tgl_surat_keluar" placeholder="Select Date..">
