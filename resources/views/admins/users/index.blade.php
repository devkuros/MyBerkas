...
@section('admin-tittle')Manage Users @endsection
...
@section('content')
    ...
    <div class="page-header">
        <div class="page-title">
            <a class="btn btn-primary float-right my-3" href="javascript:void(0)" id="createNew"> Create New User</a>
        </div>
...
<script>
    ...
    $(function () {
        ...
        $('#createNew').click(function () {
                ...
                $('#titleModal').html("Create New User");
                $('#ajaxModal').modal('show');
        });

        $('body').on('click', '.editData', function () {
                var id = $(this).data('id');
                $.get('manage-user/' + id + '/edit', function (data) {
                    $('#titleModal').html("Edit " + data.username);
        ...
        $('#ajaxForm').submit(function (e) {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    toast({
                        type: 'success',
                        title: data.username + ' data is successfully saved',
                        padding: '2em',
                    })
                },
                error: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        setTimeout(function () {
                            ...
                            toast({
                                type: 'success',
                                title: ' User is successfully delete',
                                padding: '2em',
                            })
                        });
