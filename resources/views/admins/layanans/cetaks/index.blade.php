...
@section('admin-tittle')Cetak Layanan Surat @endsection
    ...
    $(function () {
        ...
        $('body').on('click', '.editData', function () {
                ...
                $.get(' pengaturan/' + id + '/edit', function (data) {
                    ...
                    $('#ket_template').val(data.ket_template);
                })
        });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        setTimeout(function () {
                            ...
                            toast({
                                type: 'success',
                                title: ' Template is successfully delete',
                                padding: '2em',
                            })
                        });
