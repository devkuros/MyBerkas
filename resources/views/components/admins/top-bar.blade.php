    ...
    <div class="topbar-nav header navbar" role="banner">
        <nav id="topbar">
            ...
            <ul class="list-unstyled menu-categories" id="topAccordion">
                ...
                @hasrole('super admin')
                <li class="menu single-menu {{ set_active('format.index') }}{{ set_active('admin.jabatan') }}{{ set_active('admin.pejabat') }}">
                    <a href="#" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled" id="adminmeny" data-parent="#topAccordion">
                        <li class="sub-sub-submenu-list {{ set_active('admin.jabatan') }}{{ set_active('admin.pejabat') }}">
                            <a href="#starter-kit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Pimpinan <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                            <ul class="collapse list-unstyled sub-submenu eq-animated eq-fadeInUp" id="starter-kit" data-parent="#more">
                        ...
                        <li class="{{ set_active('format.index') }}">
                            <a href="{{route('format.index')}}"> Format Surat </a>
                        </li>
                    </ul>
                </li>
                @endhasrole
